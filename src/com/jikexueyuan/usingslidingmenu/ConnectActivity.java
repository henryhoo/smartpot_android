...
public class ConnectActivity extends Activity {
	...
	public void socialclick(View view) {
		Intent intent = new Intent(ConnectActivity.this, SocialActivity.class);
	...
	public void potclick(View view) {
		Intent intent = new Intent(ConnectActivity.this, PotActivity.class);
		startActivity(intent);
	}

	public void dataclick(View view) {
		Intent intent = new Intent(ConnectActivity.this, DataActivity.class);
		startActivity(intent);
	}
	...
	public void onPause() {
		...
		mConnectedThread = null; // set it to null, since the thread has been
									// stopped.
	}
